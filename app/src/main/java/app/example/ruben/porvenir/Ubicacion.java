...
public class Ubicacion extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(-98.0538106,20.1734568);
        mMap.addMarker(new MarkerOptions().position(sydney).title("El Porvenir").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_RED)));
        float zoomlevel=16;
